      ...
      <div className="flex gap-5 mt-5 ml-2">
        <form className="flex flex-col gap-3 mb-2" onSubmit={e=>e.preventDefault()} >
          ...
          {icons.map(({name,src,style},index)=>{
            return(
              <div key={index} className="flex flex-row-reverse hover:scale-105">
          ...
          <input type="range" id="encounter" value={filterData.encounter}  name="encounter" min="1" max="100"></input>
